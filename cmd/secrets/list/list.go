...
func NewCmdList() *cobra.Command {
	...
	exportCmd := cobra.Command{
		...
		Short: "Generate a report of Environment secrets for an organization and/or repositories.",
		Long:  "Generate a report of Environment secrets for an organization and/or repositories.",
